...
# CMIP5
mm_ref_ACCESS.to_netcdf('/monthly_mean_4_deg/ACCESS_anomaly_annual_ref.nc')
#mm_ref_HADGEM.to_netcdf('/monthly_mean_4_deg/HADGEM_anomaly_annual_ref.nc')
#mm_ref_HADGEM.to_netcdf('/monthly_mean_4_deg/HADGEM_anomaly_annual_ref_cloud.nc')
mm_ref_CSIRO.to_netcdf('/monthly_mean_4_deg/CSIRO_anomaly_annual_ref.nc')
mm_ref_IPSL.to_netcdf('/monthly_mean_4_deg/IPSL_anomaly_annual_ref.nc')
mm_ref_MIROC5.to_netcdf('/monthly_mean_4_deg/MIROC5_anomaly_annual_ref.nc')
mm_ref_NORESM.to_netcdf('/monthly_mean_4_deg/NORESM_anomaly_annual_ref.nc')


#CMIP6
mm_ref_CESM.to_netcdf('monthly_mean_4_deg/CESM_anomaly_annual_ref.nc')
mm_ref_CNRM_CM6.to_netcdf('/monthly_mean_4_deg/CNRM_CM6_anomaly_annual_ref.nc')
mm_ref_CNRM_ESM2.to_netcdf('/monthly_mean_4_deg/CNRM_ESM2_anomaly_annual_ref.nc')
mm_ref_MRI.to_netcdf('/monthly_mean_4_deg/MRI_anomaly_annual_ref.nc')
mm_ref_UKMO.to_netcdf('/monthly_mean_4_deg/UKMO_anomaly_annual_ref.nc')

# ====== create new netCDF files for each model - REFERENCE =====
# CMIP5
mm_ACCESS.to_netcdf('/monthly_mean_4_deg/ACCESS_anomaly_annual.nc')
#mm_HADGEM.to_netcdf('/monthly_mean_4_deg/HADGEM_anomaly_annual.nc')
#mm_HADGEM.to_netcdf('/monthly_mean_4_deg/HADGEM_anomaly_annual_cloud.nc')
mm_CSIRO.to_netcdf('/monthly_mean_4_deg/CSIRO_anomaly_annual.nc')
mm_IPSL.to_netcdf('/monthly_mean_4_deg/IPSL_anomaly_annual.nc')
mm_MIROC5.to_netcdf('/monthly_mean_4_deg/MIROC5_anomaly_annual.nc')
mm_NORESM.to_netcdf('/monthly_mean_4_deg/NORESM_anomaly_annual.nc')


#CMIP6
mm_CESM.to_netcdf('/monthly_mean_4_deg/CESM_anomaly_annual.nc')
mm_CNRM_CM6.to_netcdf('/monthly_mean_4_deg/CNRM_CM6_anomaly_annual.nc')
mm_CNRM_ESM2.to_netcdf('/monthly_mean_4_deg/CNRM_ESM2_anomaly_annual.nc')
mm_MRI.to_netcdf('/monthly_mean_4_deg/MRI_anomaly_annual.nc')
mm_UKMO.to_netcdf('/monthly_mean_4_deg/UKMO_anomaly_annual.nc')
