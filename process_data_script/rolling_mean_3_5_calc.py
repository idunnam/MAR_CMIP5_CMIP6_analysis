...
ACCESS = xr.open_dataset('/SEB_anomalies_seasonal/ACCESS_anomaly_'+season+'.nc')
HADGEM_cloud = xr.open_dataset('/SEB_anomalies_seasonal/HADGEM_anomaly_'+season+'_cloud.nc')
HADGEM_SMB = xr.open_dataset('/SEB_anomalies_seasonal/HADGEM_anomaly_'+season+'_SMB.nc')
HADGEM = xr.open_dataset('/SEB_anomalies_seasonal/HADGEM_anomaly_'+season+'.nc')
CSIRO  = xr.open_dataset('/SEB_anomalies_seasonal/CSIRO_anomaly_'+season+'.nc')
IPSL   = xr.open_dataset('/SEB_anomalies_seasonal/IPSL_anomaly_'+season+'.nc')
MIROC5 = xr.open_dataset('/SEB_anomalies_seasonal/MIROC5_anomaly_'+season+'.nc')
NORESM = xr.open_dataset('/SEB_anomalies_seasonal/NORESM_anomaly_'+season+'.nc')

#CMIP6 models
CESM      = xr.open_dataset('/SEB_anomalies_seasonal/CESM_anomaly_'+season+'.nc')
CNRM_ESM2 = xr.open_dataset('/SEB_anomalies_seasonal/CNRM_ESM2_anomaly_'+season+'.nc')
CNRM_CM6 = xr.open_dataset('/SEB_anomalies_seasonal/CNRM_CM6_anomaly_'+season+'.nc')
MRI       = xr.open_dataset('/SEB_anomalies_seasonal/MRI_anomaly_'+season+'.nc')
UKMO      = xr.open_dataset('/SEB_anomalies_seasonal/UKMO_anomaly_'+season+'.nc')
...
ACCESS_sel.to_netcdf('/rol_mean_3_5_deg/ACCESS_rol_'+str(TAS)+'_'+season+'.nc')
HADGEM_sel.to_netcdf('/rol_mean_3_5_deg/HADGEM_rol_'+str(TAS)+'_'+season+'.nc')
HADGEM_cloud_sel.to_netcdf('/rol_mean_3_5_deg/HADGEM_cloud_rol_'+str(TAS)+'_'+season+'.nc')
HADGEM_SMB_sel.to_netcdf('/rol_mean_3_5_deg/HADGEM_SMB_rol_'+str(TAS)+'_'+season+'.nc')
CSIRO_sel.to_netcdf('/rol_mean_3_5_deg/CSIRO_rol_'+str(TAS)+'_'+season+'.nc')
IPSL_sel.to_netcdf('/rol_mean_3_5_deg/IPSL_rol_'+str(TAS)+'_'+season+'.nc')
MIROC5_sel.to_netcdf('/rol_mean_3_5_deg/MIROC5_rol_'+str(TAS)+'_'+season+'.nc')
NORESM_sel.to_netcdf('/rol_mean_3_5_deg/NORESM_rol_'+str(TAS)+'_'+season+'.nc')

CESM_sel.to_netcdf('/rol_mean_3_5_deg/CESM_rol_'+str(TAS)+'_'+season+'.nc')
CNRM_ESM2_sel.to_netcdf('/rol_mean_3_5_deg/CNRM_ESM2_rol_'+str(TAS)+'_'+season+'.nc')
CNRM_CM6_sel.to_netcdf('/rol_mean_3_5_deg/CNRM_CM6_rol_'+str(TAS)+'_'+season+'.nc')
MRI_sel.to_netcdf('/rol_mean_3_5_deg/MRI_rol_'+str(TAS)+'_'+season+'.nc')
UKMO_sel.to_netcdf('/rol_mean_3_5_deg/UKMO_rol_'+str(TAS)+'_'+season+'.nc')
