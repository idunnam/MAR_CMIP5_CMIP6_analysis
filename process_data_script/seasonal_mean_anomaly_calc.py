...
# CMIP5
ACCESS_anomaly.to_netcdf('/SEB_anomalies_seasonal/ACCESS_anomaly_'+season+'.nc')
#HADGEM_anomaly.to_netcdf('/SEB_anomalies_seasonal/HADGEM_anomaly_'+season+'.nc')
#HADGEM_anomaly.to_netcdf('/SEB_anomalies_seasonal/HADGEM_anomaly_'+season+'_cloud.nc')
CSIRO_anomaly.to_netcdf('/SEB_anomalies_seasonal/CSIRO_anomaly_'+season+'.nc')
IPSL_anomaly.to_netcdf('/SEB_anomalies_seasonal/IPSL_anomaly_'+season+'.nc')
MIROC5_anomaly.to_netcdf('/SEB_anomalies_seasonal/MIROC5_anomaly_'+season+'.nc')
NORESM_anomaly.to_netcdf('/SEB_anomalies_seasonal/NORESM_anomaly_'+season+'.nc')


#CMIP6
CESM_anomaly.to_netcdf('/SEB_anomalies_seasonal/CESM_anomaly_'+season+'.nc')
CNRM_CM6_anomaly.to_netcdf('/SEB_anomalies_seasonal/CNRM_CM6_anomaly_'+season+'.nc')
CNRM_ESM2_anomaly.to_netcdf('/SEB_anomalies_seasonal/CNRM_ESM2_anomaly_'+season+'.nc')
MRI_anomaly.to_netcdf('/SEB_anomalies_seasonal/MRI_anomaly_'+season+'.nc')
UKMO_anomaly.to_netcdf('/SEB_anomalies_seasonal/UKMO_anomaly_'+season+'.nc')
