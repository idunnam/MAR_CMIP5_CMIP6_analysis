...
ACCESS = xr.open_dataset('ACCESS_COD_JJA.nc')
HADGEM = xr.open_dataset('HADGEM_COD_JJA.nc') 
CSIRO  = xr.open_dataset('CSIRO_COD_JJA.nc') 
IPSL   = xr.open_dataset('IPSL_COD_JJA.nc')  
MIROC5 = xr.open_dataset('MIROC5_COD_JJA.nc') 
NORESM = xr.open_dataset('NORESM_COD_JJA.nc')  

#CMIP6
CESM      = xr.open_dataset('CESM_COD_JJA.nc')      
CNRM_CM6  = xr.open_dataset('CNRM_CM6_COD_JJA.nc')
CNRM_ESM2 = xr.open_dataset('CNRM_ESM2_COD_JJA.nc')
MRI       = xr.open_dataset('MRI_COD_JJA.nc')       
UKMO      = xr.open_dataset('UKMO_COD_JJA.nc')      
...
sns.despine()
plt.show()
plt.savefig('CC_anomalies_CMIP5_all.png')
...
sns.despine()
plt.show()
plt.savefig('CC_anomalies_CMIP6_all.png')
