...
ACCESS = xr.open_dataset('ACCESS_anomaly_annual.nc')
HADGEM = xr.open_dataset('HADGEM_anomaly_annual.nc') 
CSIRO  = xr.open_dataset('CSIRO_anomaly_annual.nc') 
IPSL   = xr.open_dataset('IPSL_anomaly_annual.nc')  
MIROC5 = xr.open_dataset('MIROC5_anomaly_annual.nc') 
NORESM = xr.open_dataset('NORESM_anomaly_annual.nc')  

#CMIP6
CESM      = xr.open_dataset('CESM_anomaly_annual.nc')      
CNRM_CM6  = xr.open_dataset('CNRM_CM6_anomaly_annual.nc')
CNRM_ESM2 = xr.open_dataset('CNRM_ESM2_anomaly_annual.nc')
MRI       = xr.open_dataset('MRI_anomaly_annual.nc')       
UKMO      = xr.open_dataset('UKMO_anomaly_annual.nc')      
