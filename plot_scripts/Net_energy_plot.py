...
ACCESS = xr.open_dataset('ACCESS_anomaly_JJA.nc')
HADGEM = xr.open_dataset('HADGEM_anomaly_JJA.nc') 
CSIRO  = xr.open_dataset('CSIRO_anomaly_JJA.nc') 
IPSL   = xr.open_dataset('IPSL_anomaly_JJA.nc')  
MIROC5 = xr.open_dataset('MIROC5_anomaly_JJA.nc') 
NORESM = xr.open_dataset('NORESM_anomaly_JJA.nc')  

#CMIP6
CESM      = xr.open_dataset('CESM_anomaly_JJA.nc')
CNRM_CM6  = xr.open_dataset('CNRM_CM6_anomaly_JJA.nc')
CNRM_ESM2 = xr.open_dataset('CNRM_ESM2_anomaly_JJA.nc')
MRI       = xr.open_dataset('MRI_anomaly_JJA.nc')       
UKMO      = xr.open_dataset('UKMO_anomaly_JJA.nc')      
...
plt.legend(ncol=2)
plt.show()
plt.savefig('Net_fluxes_JJA.png')
#"""
